...
const createTenant = require("./testScript.js");
...
const { createUserResponseValidation } = require("./transformAndValidate");
requestData = require("./create.json")
var header = {}
var transformAndValidate = require("./transformAndValidate.js");
const moment = require('moment');
var currentTimestamp = moment().format("YYYY-MM-DD_hh-mm-ss-A");
var pathURL = "legacy-admin/client/create";
var loginAPIreq = require("../LoginAPI/request.json");
